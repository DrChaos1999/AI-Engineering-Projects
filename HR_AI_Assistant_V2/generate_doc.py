...
md_path = Path('HR_AI_Assistant_V2_Documentation.md')
pdf_path = Path('HR_AI_Assistant_V2_Documentation.pdf')
...
pdf.cell(0, 10, 'HR AI Assistant V2 Documentation', ln=True)
pdf.ln(4)
...
print('Created', md_path, 'and', pdf_path)
